...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/Jayczee", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "mailto:jayczee2716@gmail.com",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/Jayczee",
		},
	],
};
