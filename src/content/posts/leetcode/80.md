---
title: LeetCode 80：移除有序数组中的重复项 II
published: 2025-02-26
updated: 2026-03-09
description: LeetCode 80 移除有序数组中的重复项 II，记录解题思路和 Java 实现。涉及数组、双指针。
category: 算法题解
tags:
  - 数组
  - 双指针
...
对比[026 移除有序数组中的重复项](/posts/leetcode/26/)，该题难度上升在不能开辟额外的数组保存某个值是否达到删除的条件。根据题目，每个数字最多可以出现两次，即需要满足条件 `nums[i] == nums[i-1] == nums[i-2]` (i >= 2)。
