...
updated: 2026-03-09
description: LeetCode 88 合并两个有序数组，记录解题思路和 Java 实现。涉及数组、双指针、排序。
category: 算法题解
tags:
  - LeetCode
  - 数组
...
<span id="🔗-原题链接" class="legacy-anchor" aria-hidden="true"></span>

## 🔗 原题链接

[合并两个有序数组](https://leetcode.cn/problems/merge-sorted-array/description/?envType=study-plan-v2&envId=top-interview-150)

<span id="📝-合并两个有序数组" class="legacy-anchor" aria-hidden="true"></span>
