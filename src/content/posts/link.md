...
updated: 2026-03-09
description: 比较硬链接、软链接、复制和移动的区别，并整理 Debian 下的常用命令。
category: 系统与工具
tags:
  - Linux
  - 文件系统
...
<span id="🔗-硬链接" class="legacy-anchor" aria-hidden="true"></span>

## 🔗 硬链接

硬链接是一种直接指向文件数据的引用方式。可以理解为多个文件名指向同一份文件内容。

<span id="🌟-特点" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="📜-软链接" class="legacy-anchor" aria-hidden="true"></span>

## 📜 软链接

软链接，也称为符号链接，是一种指向文件路径的引用方式。可以把它想象成一个快捷方式，指向某个文件的位置。

<span id="🌟-特点-1" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="📑-复制" class="legacy-anchor" aria-hidden="true"></span>

## 📑 复制

复制操作会创建一个文件的完整副本，包含所有的数据和属性。可以理解为将文件的内容一模一样地复制到新的位置。

<span id="🌟-特点-2" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="🚚-移动" class="legacy-anchor" aria-hidden="true"></span>

## 🚚 移动

移动操作是将文件从一个位置移至另一个位置。这一过程可以看作是“剪切”和“粘贴”的结合。

<span id="🌟-特点-3" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="🐧-debian-下的操作" class="legacy-anchor" aria-hidden="true"></span>

## 🐧 Debian 下的操作

在 Debian 系统中，使用命令行可以方便地进行这些操作。

<span id="🔗-创建硬链接" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="📜-创建软链接" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="📑-复制文件" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="🚚-移动文件" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="📊-总结" class="legacy-anchor" aria-hidden="true"></span>
