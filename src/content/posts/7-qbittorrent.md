...
updated: 2026-03-09
description: 部署 qBittorrent 容器，配置下载目录、Web 界面和分类管理。
category: NAS 与影音
tags:
  - qBittorrent
  - Docker
...
<span id="📌-配置说明" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="🌐-可选配置" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="🌐-bt传输端口" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="🎉-完成部署" class="legacy-anchor" aria-hidden="true"></span>
...
- [qBittorrent 分类管理](/posts/qbit-category/)
