...
<span id="📌-ddns-go的作用" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="⚙️-前提" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="🚀-部署ddns-go容器" class="legacy-anchor" aria-hidden="true"></span>

## 🚀 部署DDNS-GO容器

在[Portainer 容器管理](/posts/2-portainer/)中，已完成Portainer的安装，接下来将使用已部署的Portainer容器完成ddns-go服务的安装。
...
<span id="🐳-docker-run-安装" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="📦-docker-compose-安装" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="⚙️-配置ddns-go" class="legacy-anchor" aria-hidden="true"></span>
...
不过，一个服务添加一条解析记录通常比较麻烦，因此一般直接添加一条`*.domain.com`，这样可以将域名下的任何二级域名解析到NAS上。同时配合NGINX反向代理，将不同的二级域名代理到不同服务上。[相关链接：Nginx反向代理](/posts/5-nginx/)。
