...
updated: 2026-03-09
description: 为 Docker daemon 配置 HTTP 代理，让镜像拉取请求通过代理服务。
category: 网络与服务
tags:
  - Docker
  - 代理配置
...
<span id="🛠️-docker-代理配置" class="legacy-anchor" aria-hidden="true"></span>

## 🛠️ Docker 代理配置

<span id="_1-配置环境变量" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="_2-重新加载-systemctl-环境变量" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="_3-重启-docker-服务" class="legacy-anchor" aria-hidden="true"></span>
