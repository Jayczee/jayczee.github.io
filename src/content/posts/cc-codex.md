...
updated: 2026-03-09
description: 记录 Claude Code 与 Codex 在日常开发中的体验、配置方式和 Windows 下的使用问题。
category: AI 与大模型
tags:
  - AI 编程
  - Claude Code
...
<span id="安装-配置" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="settings-json" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="config-toml" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="auth-json" class="legacy-anchor" aria-hidden="true"></span>
