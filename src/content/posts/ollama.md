...
updated: 2026-03-09
description: 用 Ollama 在 Windows 上下载和运行 DeepSeek R1 蒸馏模型，记录安装步骤和显存选择。
category: AI 与大模型
tags:
  - Ollama
  - DeepSeek
...
<span id="🛠️-安装并运行ollama" class="legacy-anchor" aria-hidden="true"></span>
...
<span id="📥-下载并运行deepseek-r1模型" class="legacy-anchor" aria-hidden="true"></span>
